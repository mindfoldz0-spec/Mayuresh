...
export const BootLoader: React.FC = () => {
  ...
  useEffect(() => {
    // Start asset preloading immediately in background
    preloadAllAssets();

    // Stage 1 duration timer (2.2 seconds)
  ...
  return (
    ...
    >
      {/* Main Windows Logo & Loading Ring */}
      <div className="flex flex-col items-center justify-center">
        ...
        >
          <AppIcon id="windows" size={84} alt="Windows Boot Logo" />
        </motion.div>
